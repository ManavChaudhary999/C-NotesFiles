...
// 1. Static inside the class or struct means it is gonna share memory address to all the instances of that class or struct.
// Meaing there is going to be one instance of that static symbol out of all multiple instacncs of class or structs.
...
class Player {
	...
	{
		std::cout<< speed << x <<std::endl; // x can't be used coz it is not static
	}
};
...
int main() 
{
	...
	Player::otherSpeed = 100; //also a way to get access of private static
}
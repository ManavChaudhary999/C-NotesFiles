...
// Primitive Data Types have some default byte size like char - 1, bool-1, int - 4, short - 2, float-4, long - 4(usually), long long - 8, double-8
...
// we can use unsigned keyword before any data type to remove signed bit usage like
// using unsigned int to store 32 bit value meaning 2^32 2billion X 2.
// To check size of any data type we can use sizeof datatype or sizeof(datatype).
...
int main() 
{
	...
	float b = 5.5; // also double
	double c = 5.8;
	float d = 8.0f; // like this

// Struct is a collection or group of data and functionality.
...
// Classes can be used where there is more functionality or data demand like Player Class.
